...
export const Info = Schema.Struct({
  ...
  subagent_model: Schema.optional(Schema.String).annotate({
    description:
      "Default model for all subagents in the format of provider/model. Used when a subagent has no per-agent model. Falls back to the parent session model.",
  }),
